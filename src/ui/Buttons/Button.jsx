      ...
      <button
        ...
        <div
          className="rounded-[16px]  px-3 py-2 transition duration-300
               bg-gradient-to-r from-primary-400 via-primary-500 to-primary-400 group-hover:from-white group-hover:via-white group-hover:to-white font-medium text-white">
          {title}
        </div>
      </button>
    </>
