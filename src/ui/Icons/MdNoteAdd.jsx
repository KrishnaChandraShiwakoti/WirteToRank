      ...
      <svg
        ...
        <g id="SVGRepo_iconCarrier">
          ...
          <path
            ...
            fill="#645be8"></path>{" "}
          <path
            d="M6.5 13C10.0899 13 13 10.0899 13 6.5C13 5.21136 12.625 4.0103 11.9782 3H17.75C19.5449 3 21 4.45507 21 6.25V13H16.25C14.4551 13 13 14.4551 13 16.25V21H6.25C4.45507 21 3 19.5449 3 17.75V11.9782C4.0103 12.625 5.21136 13 6.5 13Z"
            fill="#645be8"></path>{" "}
          <path
            d="M20.56 14.5L14.5 20.56V16.25C14.5 15.2835 15.2835 14.5 16.25 14.5H20.56Z"
            fill="#645be8"></path>{" "}
        </g>
      </svg>
    </div>
