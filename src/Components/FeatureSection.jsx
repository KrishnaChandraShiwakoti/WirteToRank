      ...
      <div
        ...
        <div className="flex gap-5 w-7/12 mt-5">
          ...
          <div className="flex flex-col justify-center items-Start gap-3 ml-5">
            ...
            <p>
              Create thousands of location-specific landing pages optimized for
              local SEO. Target every suburb, city, and region with unique,
              relevant content
            </p>
            <ul>
              <li className="flex">
        ...
        <div className="flex gap-5 w-7/12 mt-5">
          <div className="flex flex-col justify-center items-Start gap-3 ml-5">
            ...
            <p>
              Intelligently analyze and extract your competitors' sucessful SEO
              strategies. Discover their top-performing content and KeyWords
            </p>
            <ul>
              <li className="flex">
                <img src={customBullets} alt="" srcset="" />
